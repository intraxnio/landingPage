      ...
      <div className="container mt-5">
        <div className="container row mx-auto">
          <div className="col-12 col-md-6 col-lg-6 my-auto">
            <div className="row bb-txt-1"><h1><span className="creator-underline">Create a Campaign</span> in 3 easy steps.</h1></div>
            <div className="row bb-txt-2"><p>Content creation has become more important than ever for businesses looking to build a strong online 
              ...
              <code>BroadReach</code> will help you identify the influencers that align with your brand values and target audience.</p></div>
          </div>
