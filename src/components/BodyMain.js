  ...
  return (
    <>
      ...
      <div className="container row justify-content-center mt-5 mb-5 pt-4 pb-4 mx-auto">
        <div className="container col-6 col-md-3 col-lg-3 text-center body-tag-styles"> 15k+ <br/> <span className="body-bottom-tag-styles">Creators</span>  </div>
        <div className="container col-6 col-md-3 col-lg-3 text-center body-tag-styles"> 80+ <br/> <span className="body-bottom-tag-styles">Brands</span>  </div>
        <div className="container col-6 col-md-3 col-lg-3 text-center body-tag-styles"> 5000+ <br/> <span className="body-bottom-tag-styles">Campaigns</span>  </div>
        <div className="container col-6 col-md-3 col-lg-3 text-center body-tag-styles"> 500k+ <br/> <span className="body-bottom-tag-styles">Revenue</span>  </div>
